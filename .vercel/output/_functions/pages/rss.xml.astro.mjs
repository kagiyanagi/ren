...
import { A as AstroError, U as UnknownContentCollectionError, e as createComponent, R as RenderUndefinedEntryError, u as unescapeHTML, f as renderTemplate, g as escape, h as renderUniqueStylesheet, i as renderScriptElement, j as createHeadAndContent, k as renderComponent } from '../chunks/astro/server_DS5lBA-s.mjs';
...
import { u as unflatten } from '../chunks/parse_BxWlCxqB.mjs';
import { S as SITE_DESCRIPTION, a as SITE_TITLE } from '../chunks/consts_DFLqPF7G.mjs';
...
class ImmutableDataStore {
  ...
  static async fromModule() {
    try {
      const data = await import('../chunks/_astro_data-layer-content_C2BdgAqf.mjs');
...
const __vite_import_meta_env__ = {"ASSETS_PREFIX": undefined, "BASE_URL": "/", "DEV": false, "MODE": "production", "PROD": true, "SITE": "https://aquakun.vercel.app/", "SSR": true};
...
async function updateImageReferencesInBody(html, fileName) {
  ...
  const { getImage } = await import('../chunks/_astro_assets_zZ4YnRIA.mjs').then(n => n._);
